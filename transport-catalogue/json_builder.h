...
namespace json {
    ...
    class KeyItemContext {
    public:
        virtual ValueAfterKeyItemContext& Value(Node value) = 0;
    ...
    class ArrayItemContext {
    public:
        virtual ArrayItemContext& Value(Node value) = 0;
        virtual DictItemContext& StartDict() = 0;
        virtual ArrayItemContext& StartArray() = 0;
    ...
    public:
        virtual ValueItem& Value(Node value) = 0;
    ...
    public:
        ...
        ValueItem& Value(Node value) override;
